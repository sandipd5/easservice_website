            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 news-wrapper">
                    ...
                    <article class="article">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 a_content">
                            ...
                            <div class="a_text">
                                ...
                                <p class="a_news">{!! $news->description !!}</p>
                            </div>
                        </div>
                    
                        <p style="columns: black">Share this:</p>
                        <div class="fb-share-button" data-href="https://web.easy.com.np/news/{{$news->id}}" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fweb.easy.com.np%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
                    </article>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 news-widget">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fb-feed">
                        <h3>Facebook Feed</h3>
                        <div class="fb-page" data-href="https://www.facebook.com/EasyService/"
                            data-tabs="timeline" data-small-header="true" data-adapt-container-width="true"
                            data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="https://www.facebook.com/EasyService/"
